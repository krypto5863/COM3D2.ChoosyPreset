...
3. Restart your game, select the new language file in the [ConfigurationManager](https://github.com/BepInEx/BepInEx.ConfigurationManager) Or BepinexConfigManager (F1 when installed) or manually set the name of the language file in the ChoosyPreset cfg file.
